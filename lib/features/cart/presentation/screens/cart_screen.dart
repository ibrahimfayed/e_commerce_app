      ...
      body: Padding(
        ...
        child: BlocConsumer<CartCubit, CartState>(
          listener: (context, state) {
            if (state is UpdateProductQuantityLoading ||
                state is RemoveProductFromCartLoading) {
              UIUtils.showLoading(context);
            } else if (state is UpdateProductQuantitySuccess ||
                state is RemoveProductFromCartSuccess) {
              UIUtils.showLoading(context);
